 ...
 * @param {Pin} `pin`
 */
Timeline.prototype.sendUserPin = function (userToken, pin) {
 ...
 * @param {Pin} `pin`
 */
Timeline.prototype.sendSharedPin = function (apiKey, topics, pin) {
  if (!pin instanceof(Pin)) {
    console.log('Error: invalid pin');
    return;
  }
 ...
 * @param {String} `topic`
 */
Timeline.prototype.subscribe = function (userToken, topic) {
  var headers = {'X-User-Token': userToken};
 ...
 * @param {String} `topic`
 */
Timeline.prototype.unsubscribe = function (userToken, topic) {
  var headers = {'X-User-Token': userToken};
