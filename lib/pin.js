...
var Pin = module.exports = function (opts) {
  ...
  if (opts && opts.createMessage) {
    if (false === opts.createMessage instanceof Notification) {
  ...
  if (opts && opts.updateMessage) {
    if (false === opts.updateMessage instanceof Notification) {
  ...
  if (opts && opts.reminders) {
    if (false === opts.reminders instanceof Array) {
  ...
  if (opts && opts.actions) {
    if (false === opts.actions instanceof Array) {
...
Pin.prototype.addReminder = function (reminder) {
  if (false === reminder instanceof Reminder) {
