...
var Layout = module.exports = function (opts) {
  ...
  if (opts && opts.sportsInGame) {
    if (typeof opts.sportsInGame !== 'boolean') {
      throw new Error('Expected sportsInGame to be a boolean.');
    }
    this._layout.sportsInGame = opts.sportsInGame;
  }
};
